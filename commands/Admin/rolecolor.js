...
module.exports = {
    ...
    run: (client, message, args) => {
        try {
            ...
            const role = message.mentions.roles.first() || message.guild.roles.cache.find(r => r.name.toLowerCase() == args.slice(1).join(" ").toLowerCase()) || message.guild.roles.cache.get(args.slice(1).join(" "))
