...
function handletranslate(data, extra) {
    ...
    return translateToken
        ...
        var options = __assign({ method: "POST", headers: headers, data: util_1.arrayStringify(data), url: '/translate_a/t', baseURL: "https://translate.googleapis.com", params: query, proxy: extra.proxy || false }, (extra.config));
