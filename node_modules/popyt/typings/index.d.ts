...
export declare class YouTube {
     ...
     */
    constructor(token?: string, accessToken?: string, options?: YouTubeOptions);
    /**
     * @ignore
     */
     ...
     */
    getSubscriptionByChannels(subscriberResolvable: string, channelResolvable: string): Promise<Subscription>;
    /**
     ...
     */
    getChannelSubscriptions(channelResolvable: string, maxResults?: number): Promise<Subscription[]>;
    /**
     ...
     */
    getCategories(region?: string, all?: boolean): Promise<VideoCategory[]>;
}
