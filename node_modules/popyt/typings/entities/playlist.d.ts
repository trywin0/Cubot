...
export declare class Playlist {
     ...
     */
    addVideo(videoResolvable: string, position?: number, note?: string): Promise<Video>;
    /**
     ...
     */
    updateVideo(videoResolvable: string, position?: number, note?: string, itemId?: string): Promise<Video>;
    /**
