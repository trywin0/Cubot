...
class OAuth {
    ...
    replyToComment(commentId, text) {
        return __awaiter(this, void 0, void 0, function* () {
            this.checkTokenAndThrow();
            const data = JSON.parse(JSON.stringify(constants_1.CommentData));
     ...
     */
    addPlaylistItem(playlistId, videoId, position, note) {
        return __awaiter(this, void 0, void 0, function* () {
            this.checkTokenAndThrow();
            const data = JSON.parse(JSON.stringify(constants_1.PlaylistItemData));
     ...
     * @returns A partial video object.
     */
    updatePlaylistItem(id, playlistId, videoId, position, note) {
        return __awaiter(this, void 0, void 0, function* () {
            this.checkTokenAndThrow();
            const data = JSON.parse(JSON.stringify(constants_1.PlaylistItemData));
            const parts = ['id', 'snippet'];
