...
class YouTube {
     ...
     */
    constructor(token, accessToken, options = { cache: true, cacheTTL: 600, cacheCheckInterval: 600, cacheSearches: true }) {
        /**
         * @ignore
         */
     ...
     */
    getCategories(region = 'US', all = false) {
        return services_1.GenericService.getPaginatedItems(this, 'videoCategories', false, region, all ? -1 : 100);
    }
}
